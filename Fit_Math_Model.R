...
write.csv(math_data, "Raw_data//maths_data.csv")
...
write.csv(maths_samples, "MCMC_samples//maths_samples_tmp.csv")
...
write.csv(maths_samples_2, "MCMC_samples//maths_samples_w_attainment.csv")
